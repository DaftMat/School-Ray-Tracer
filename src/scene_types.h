...
typedef struct scene_s {
  ...
  Objects objects; //! the scene have severapoint3(obj->geom.sphere.center.x, obj->geom.sphere.center)point3(obj->geom.sphere.center.x, obj->geom.sphere.center)l objects
